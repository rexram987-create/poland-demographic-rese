(function () {
  ...
  const cityLinksEn = [["cities/warsaw-en.html","Warsaw","Capital city"],["cities/krakow-en.html","Kraków","Royal city"],["cities/lodz-en.html","Łódź","Industry and textiles"],["cities/gdansk-en.html","Gdańsk","Port and freedom"],["cities/wroclaw-en.html","Wrocław","Bridges and islands"],["cities/poznan-en.html","Poznań","Early Poland"],["cities/sieradz-en.html","Sieradz","Jewish heritage"]];
  ...
  function getLanguageTarget(en){const current=location.pathname.split("/").pop()||"index.html";const map={"index.html":"index-en.html","index-en.html":"index.html","jewish-poland.html":"jewish-poland-en.html","jewish-poland-en.html":"jewish-poland.html","jewish-timeline.html":"jewish-timeline-en.html","jewish-timeline-en.html":"jewish-timeline.html","folklore-archive.html":"folklore-archive-en.html","folklore-archive-en.html":"folklore-archive.html","sieradz.html":"sieradz-en.html","sieradz-en.html":"sieradz.html"};if(map[current])return map[current];return en?current.replace("-en.html",".html"):current.replace(".html","-en.html");}
